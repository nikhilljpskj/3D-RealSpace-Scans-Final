...
const DEMO_DATA = [
  {
    ...
    content:
      "This place is exactly like the picture posted on 3drealspacescans. Great service, we had a great stay!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    ...
    >
      <Heading desc="Let's see what people think of 3drealspacescans" isCenter>
